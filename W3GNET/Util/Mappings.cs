...
namespace W3GNET.Util
{
  ...
  { "dthb", "i_Thunderbloom Bulb" },
        ...
        internal static Dictionary<string, string> Units = new Dictionary<string, string>
        {
            { "hfoo", "u_Footman" },
  { "hkni", "u_Knight" },
  { "hmpr", "u_Priest" },
  ...
  { "nndr", "u_Nether Dragon" },
        ...
        internal static Dictionary<string, string> Buildings = new Dictionary<string, string>
        {
  { "hhou", "Farm" },
  { "halt", "Altar of Kings" },
  { "harm", "Workshop" },
  ...
  { "uzg2", "b_Nerubian Tower" },
        ...
        internal static Dictionary<string, string> Upgrades = new Dictionary<string, string>
        {
  ...
  { "Rupm", "p_Backpack" },
        ...
        internal static Dictionary<string, string> HeroAbilities = new Dictionary<string, string>
        {
  ...
  { "ANtm", "a_Goblin Alchemist:Transmute" },
        ...
        internal static Dictionary<string, string> AbilityToHero = new Dictionary<string, string>
        {
  { "AHbz", "Hamg" },
  { "AHwe", "Hamg" },
  { "AHab", "Hamg" },
